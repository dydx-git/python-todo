...
class CountingThread(threading.Thread):
    ...
    def main_loop(self):
        ...
        if now < self.end_time:
            ...
            mins, sec = divmod(time_difference.seconds, 60)
...
class Timer(tk.Tk):
    def __init__(self):
        ...
        self.main_frame = tk.Frame(self, width=500, height=300, bg="blue")
        self.task_name_label = tk.Label(
            self.main_frame, text="Task Name:", bg="blue", fg="black", font=self.standard_font
        )
        self.task_name_entry = tk.Entry(
            self.main_frame, bg="white", fg="black", font=self.standard_font
        )
        ...
        self.time_remaining_label = tk.Label(
            self.main_frame, textvar=self.time_remaining_var, bg="blue", fg="black", font=(None, 40)
        )
